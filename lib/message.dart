...
class Message {
	...
	String address;
	String tags = "";
	List<List<int>> rawdata = <List<int>>[]; // each argument will be a list of int
	...
	void parse() {
		...
		if (commasplit.length < 2) { // if there is no comma
	...
	void clearProperties() { // clears the properties of the message except the packet
		address = "";
		tags = "";
		rawdata = <List<int>>[];
		return;
